...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\dev web\\nextJS\\next-auth\\prisma\\app\\generated\\prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "mongodb+srv://asaw:M91cPejZSuSnRFLq@next-auth.lpamajb.mongodb.net/next-auth"
      }
    }
  },
  "inlineSchema": "datasource db {\n  provider     = \"mongodb\"\n  url          = env(\"DATABASE_URL\")\n  relationMode = \"prisma\"\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"app/generated/prisma/client\"\n}\n\nmodel User {\n  id       String @id @default(auto()) @map(\"_id\") @db.ObjectId\n  email    String @unique\n  password String\n}\n\n// npx prisma generate\n// npx prisma db push\n",
  "inlineSchemaHash": "dcfdaeacfa929fba4f38c831c6da69a4cac4ed273c60a9f1640048f0d746e10b",
  "copyEngine": true
}
